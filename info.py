...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ranjuvishwakarma50:aman@cluster0.yii1hop.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

premium = environ.get('PREMIUM_LOGS', '-1002062708890')
...
LAZY_GROUP_LOGS = int(environ.get('LAZY_GROUP_LOGS', -1002062708890))
...
# Streaming
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002062708890")
...
URL = "https://hi-96c7.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://hi-96c7.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://hi-96c7.onrender.com/".format(FQDN)
else:
    URL = "https://hi-96c7.onrender.com/".format(FQDN)
